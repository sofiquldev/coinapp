                    ...
                    (counters.forEach((n, e) => {
                        ...
                        a(),
                            n.parentElement.style.animation
                                ? (n.parentElement.style.animation = "")
                                : (n.parentElement.style.animation = `slide-up 0.3s ease forwards ${e / counters.length + 1.5
                                    }s`);
                    }),
                ...
                e.isIntersecting &&
                    (trusted_counters.forEach((n, e) => {
                        ...
                        a(),
                            n.parentElement.style.animation
                                ? (n.parentElement.style.animation = "")
                                : (n.parentElement.style.animation = `slide-up 0.3s ease forwards ${e / trusted_counters.length + 1.5
                                    }s`);
                    }),
