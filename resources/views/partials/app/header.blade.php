<header class="fixed left-0 pt-8 z-[1000000000] duration-500  transition-all w-full bg-transparent"
    ...
    <nav class="container flex  items-center ">
        ...
        dark:hover:border-borderColour/10 duration-500 hover:duration-500 transition-colors {{ Route::currentRouteName() == 'home' ? 'active' : '' }}">
                    Home
                </a>
            </li>
            <li>
                <a href="{{ route('trade') }}"
                    class="font-Inter flex items-center text-base font-medium leading-8 text-paragraph dark:text-white py-[5px] px-5 lg:px-4 xl:px-5 border rounded-large border-transparent hover:bg-white hover:border-borderColour dark:hover:bg-dark-200
        dark:hover:border-borderColour/10 duration-500 hover:duration-500 transition-colors {{ Route::currentRouteName() == 'trade' ? 'active' : '' }}">
                    Trading
                </a>
            </li>
            <li>
                <a href="{{ route('wallet') }}"
                    class="font-Inter flex items-center text-base font-medium leading-8 text-paragraph dark:text-white py-[5px] px-5 lg:px-4 xl:px-5 border rounded-large border-transparent hover:bg-white hover:border-borderColour dark:hover:bg-dark-200
        dark:hover:border-borderColour/10 duration-500 hover:duration-500 transition-colors {{ Route::currentRouteName() == 'wallet' ? 'active' : '' }}">
                    Wallet
                </a>
            </li>
        </ul>
