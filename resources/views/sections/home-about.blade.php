<section class=" overflow-hidden relative pb-150 max-md:pb-20">
    <div class="container relative z-10">
        <div class="grid grid-cols-2 max-md:grid-cols-1 gap-10 1xl:gap-x-24 items-center">
            <div class="relative flex max-md:justify-center justify-end items-center">
                <img src="{{ asset('images/about/onlinePayment.png') }}" alt="banking image" class="dark:hidden max-w-[250px] lg:max-w-[320px] xl:max-w-[420px]" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-once="true">
                <img src="{{ asset('images/about/onlinePayment-dark.png') }}" alt="banking image" class="hidden dark:inline-block  max-w-[250px] lg:max-w-[320px] xl:max-w-[420px]" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-once="true">
                <div class="absolute left-0 right-auto bottom-8 top-auto max-w-[180px] md:max-w-[250px] xl:max-w-[344px] " data-aos="fade-right" data-aos-offset="200" data-aos-duration="1000" data-aos-once="true">
                    <img src="{{ asset('images/about/onlinePayment-shape.png') }}" alt="banking image" class="dark:hidden">
                    <img src="{{ asset('images/about/onlinePayment-shape-dark.png') }}" alt="banking image" class="hidden dark:inline-block ">
                </div>
            </div>
    ...
    <div class="container  overflow-hidden max-lg:!px-0">
        <div class="relative after:absolute before:absolute after:w-[120px] after:h-[40px] after:bg-gradient-to-r after:from-white after:from-[37.5%]  after:top-1/2 after:-translate-y-1/2 after:left-0 after:z-10 before:w-[120px] before:h-[40px] before:bg-gradient-to-l before:from-white before:from-[37.5%] before:right-0  before:top-1/2 before:-translate-y-1/2  before:z-10 dark:after:from-dark-gradient dark:before:from-dark-gradient">
            <div class="absolute left-0 -top-[1px] w-full max-lg:hidden">
                <img src="{{ asset('images/clients/client-border.svg') }}" alt="border" class="inline-block dark:hidden">
                <img src="{{ asset('images/clients/client-border-dark.svg') }}" alt="border" class="hidden dark:inline-block">
            </div>
            <div class="marquee marquee-items  ">
                <div class="marquee-content flex items-center justify-between py-8 " id="clients">
                    <div class="marquee-content-list">
                        <img src="{{ asset('images/clients/group.svg') }}" alt="group" class="inline-block dark:hidden">
                        <img src="{{ asset('images/clients/group-dark.svg') }}" alt="group" class="hidden dark:inline-block">
                    </div>
                    <div class="marquee-content-list ">
                        <img src="{{ asset('images/clients/infinity.svg') }}" alt="infinity" class="inline-block dark:hidden">
                        <img src="{{ asset('images/clients/infinity-dark.svg') }}" alt="infinity" class="hidden dark:inline-block">
                    </div>
                    <div class="marquee-content-list ">
                        <img src="{{ asset('images/clients/artifact.svg') }}" alt="artifact" class="inline-block dark:hidden">
                        <img src="{{ asset('images/clients/artifact-dark.svg') }}" alt="caudile" class="hidden dark:inline-block">
                    </div>
                    <div class="marquee-content-list ">
                        <img src="{{ asset('images/clients/caudile.svg') }}" alt="caudile" class="inline-block dark:hidden">
                        <img src="{{ asset('images/clients/caudile-dark.svg') }}" alt="caudile" class="hidden dark:inline-block">
                    </div>
                    <div class="marquee-content-list ">
                        <img src="{{ asset('images/clients/axeptio.svg') }}" alt="axeptio" class="inline-block dark:hidden">
                        <img src="{{ asset('images/clients/axeptio-dark.svg') }}" alt="axeptio" class="hidden dark:inline-block">
                    </div>
                    <div class="marquee-content-list ">
                        <img src="{{ asset('images/clients/mfinity.svg') }}" alt="mfinity" class="inline-block dark:hidden">
                        <img src="{{ asset('images/clients/mfinity-dark.svg') }}" alt="mfinity" class="hidden dark:inline-block">
                    </div>
                </div>
            </div>
        </div>
